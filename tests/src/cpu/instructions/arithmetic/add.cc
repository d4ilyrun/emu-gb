...
CASES(negative, s8_to_sp) = {
    {0x000F, {0xE8, 0xFF}, 0x000E}, {0x1A0F, {0xE8, 0xFF}, 0x1A0E},
    {0x003F, {0xE8, 0x81}, 0x00C0}, // negative overflow
    {0x1A3F, {0xE8, 0x81}, 0x1BC0}, // negative overflow
    {0x103F, {0xE8, 0x81}, 0x00C0}, // negative overflow
