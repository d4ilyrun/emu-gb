 ...
 *
 * This 48 bytes represent the Nintendo logo that is shown when the Game Boy is powered on
 * (the ones that appear corrupted if the cartridge is not inserted correctly, for example).
 */
